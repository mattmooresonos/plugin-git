function __git.init
  ...
  __git.create_abbr gfm        "git fetch origin main --prune; and git merge FETCH_HEAD"
  ...
  __git.create_abbr glom       git log --oneline --decorate --color main..
  ...
  __git.create_abbr grbm       git rebase main
  __git.create_abbr grbmi      git rebase main --interactive
  __git.create_abbr grbmia     git rebase main --interactive --autosquash
  __git.create_abbr grbd       git rebase develop
  __git.create_abbr grbdi      git rebase main --interactive
  __git.create_abbr grbdia     git rebase main --interactive --autosquash
